...
//********************************************
// Class that contains functions for food menu
//********************************************
...
//***************************************
//  Function to append from food menu
//***************************************
 
     void food::app_fmenu(void)
     {
	  p1.open("food.txt",ios::app|ios::binary);
	  outtextxy(30,360,"ENTER ITEM NAME YOU WANT TO ADD");
	  gotoxy(60,23);
	  gets(f.name);
...
//************************************
//  Funtion to delete from food menu
//************************************
     void food::del_all()
     {
	  remove("food.txt");
...
//***************************************
// Class that contains customer info
//***************************************
...
//*************************
     ...
     void room_bill()
     {
	  ...
	  setcolor(4);
	  settextstyle(7,0,1);
	  outtextxy(30,70,"ENTER CUSTOMER NOT DEPARTING");
	  gotoxy(50,6);
	  cin>>no;
...
//**********************************************
//  Function to display if customer is in hotel
//**********************************************
...
//*************************************
//  Function to modify customers info
//*************************************
...
//*********************************************
//  Function to delete all of customers info
//*********************************************
...
//*************************************
//  Function to delete customer info
//*************************************
     ...
     void cust_del()
     {
	  ...
	  setcolor(4);
	  int no,count=1;
	  outtextxy(30,42,"ENTER CUSTOMER NOT TO BE DELETED");
	  gotoxy(65,4);
	  cin>>no;
	  f1.open("cust.txt",ios::in|ios::binary);
	  fstream f2;
...
//***********************************
//   Class that controls all classes
//***********************************
